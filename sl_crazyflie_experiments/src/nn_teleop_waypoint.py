...
class Teleop:
    def __init__(self):
        ...
        self.next_goal = rospy.ServiceProxy("/next_goals", Empty)

        self.prev_pressed = {'nn': False, 'new_goal': False}
        rate = rospy.Rate(5)
    ...
    def joy_callback(self, joy_msg):
        ...
        elif self.is_button_released('new_goal', joy_msg.buttons[NEW_GOAL_BUTTON]):
            self.next_goal.call()
